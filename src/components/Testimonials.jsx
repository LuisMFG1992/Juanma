    ...
    <>
      <section className='body-font bg-light text-gray-600'>
        <div className='container mx-auto px-5 py-24'>
          <h1 className='mb-12 text-center text-3xl text-title font-medium text-gray-900'>
            Testimonials
          </h1>
          <div className='-m-4 flex flex-wrap'>
            <div className='w-full p-4 md:w-1/2'>
              <div className='h-full rounded bg-gray-100 p-8'>
                ...
                <p className='mb-6 text-paragraph leading-relaxed'>
                ...
                <a className='inline-flex items-center'>
                  ...
                  <span className='flex flex-grow flex-col pl-4'>
                    ...
                    <span className='text-paragraph text-gray-500'>
                      UI DEVELOPER
                    </span>
                  </span>
                </a>
