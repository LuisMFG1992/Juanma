          ...
          <div className='-m-4 flex flex-wrap text-center'>
            <div className='w-full p-4 sm:w-1/2 md:w-1/4'>
              <div className='rounded-lg border-2 border-gray-200 bg-white px-4 py-6'>
                ...
                <p className='text-paragraph leading-relaxed'>Downloads</p>
              </div>
            </div>
            <div className='w-full p-4 sm:w-1/2 md:w-1/4'>
              <div className='rounded-lg border-2 border-gray-200 bg-white px-4 py-6'>
                ...
                <p className='text-paragraph leading-relaxed'>Users</p>
              </div>
            </div>
            <div className='w-full p-4 sm:w-1/2 md:w-1/4'>
              <div className='rounded-lg border-2 border-gray-200 bg-white px-4 py-6'>
                ...
                <p className='text-paragraph leading-relaxed'>Files</p>
              </div>
            </div>
            <div className='w-full p-4 sm:w-1/2 md:w-1/4'>
              <div className='rounded-lg border-2 border-gray-200 bg-white px-4 py-6'>
                ...
                <p className='text-paragraph leading-relaxed'>Places</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className='p-4 md:w-1/2 lg:w-1/4'>
              <div className='flex h-full flex-col items-center text-center'>
                ...
                <div className='w-full'>
                  ...
                  <h3 className='text-paragraph mb-1 text-gray-500'>
                    PV Optimization Expert & Founder
                  </h3>
                  <h3 className='text-paragraph mb-3 text-gray-500'>
                    MSc. Mechanical Eng.
                  </h3>
