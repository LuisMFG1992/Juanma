const PrivacyPolicy = () => {
  return (
    <div className='px-6'>
      <h2 className='mb-4 pt-6 text-subtitle font-medium'>Privacy Policy</h2>

      <p className='mb-4 text-paragraph'>Last updated: November 10, 2023</p>

      <p className='mb-4 text-paragraph'>
        This Privacy Policy describes Our policies and procedures on the
        collection, use, and disclosure of Your information when You use the
        Service and tells You about Your privacy rights and how the law protects
        You. We attach great importance to the protection of your personal data
        and its security in accordance with the EU General Data Protection
        Regulation (GDPR).
      </p>
      ...
      <h2 className='mb-4 pt-6 text-subtitle font-medium'>
      ...
      <h2 className='mb-4 pt-6 text-subtitle font-medium'>Definitions</h2>
      ...
      <p className='mb-4 text-paragraph'>
        ...
        Our in this Agreement) refers to FIDgate, Berlin-Mitte, Germany.
      </p>
      <p className='mb-4 text-paragraph'>
      ...
      <p className='mb-4 text-paragraph'>
        <strong>Country</strong> refers to: Berlin-Mitte, Germany
      </p>
      <p className='mb-4 text-paragraph'>
      ...
      <p className='mb-4 text-paragraph'>
        <strong>Website</strong> refers to FIDgate, accessible from
        [https://fidgate.com/](https://fidgate.com/)
      </p>
      <p className='mb-4 text-paragraph'>
      ...
      <ul className='mb-4 ml-6  list-inside list-disc text-paragraph'>
        <li>Email address</li>
      ...
      <p className='mb-4 text-paragraph'>
        ...
        new technologies and features, it may become necessary to change this
        privacy policy. We reserve the right to make appropriate changes at any
        time.
      </p>
      ...
      <p className='mb-4 text-paragraph'>FIDgate, Berlin-Mitte, Germany</p>
      <p className='mb-4 text-paragraph'>mail: jmr@fidgate.com</p>
      <p className='mb-4 text-paragraph'>phone: (+49) 15566 401840</p>

      <p className='mb-4 text-paragraph'>dataprotection@fidgate.com</p>
    </div>
  )
}
