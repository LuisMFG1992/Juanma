      ...
      <section className='body-font  text-gray-600'>
        <div className='container mx-auto px-5 py-24'>
          <div className='mb-20 flex w-full flex-col flex-wrap items-center text-center'>
            <h1 className='mb-2 text-title font-medium text-primary sm:text-3xl'>
              Benefits
            </h1>
            <p className='w-full text-paragraph leading-relaxed text-gray-500 lg:w-1/2'>
        ...
        <div className='flex flex-col items-center justify-center gap-4 px-5 pb-16 text-center'>
          <p className='mb-2 text-title font-medium text-primary'>
            Ready to power up your projects?
          </p>
          <a href='https://calendly.com/jmr-fidgate/'>
            <button className='inline-flex rounded border-0 bg-primary px-6 py-2 text-subtitle text-white hover:bg-opacity-80 focus:outline-none'>
              Book a meeting
            </button>
          </a>
        </div>
